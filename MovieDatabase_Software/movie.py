...
class Movie:
    ...
    def __init__(self,root):
        ...
        main_frame.place(x=0,y=150,width=1366,height=580)
        ...
        cast_button.grid(row=5,column=0)
                                    ...
                                    # Date Label
        self.cdate = Label(button_frame,text=self.dt_string,width=18,font='Helvetica  13 bold',bg='black',fg= 'dark cyan',bd=6)
        self.cdate.grid(row=6,column=0,sticky=W)
        self.clock()        

                            # Images_2
        img_mov=Image.open("Main_Images/mainmoviz.jpg")
        img_mov= img_mov.resize((1310,550),Image.ANTIALIAS)
        self.img2=ImageTk.PhotoImage(img_mov)

        limg2=Label(main_frame,image=self.img2,bg='black',bd=0,relief=RIDGE)
        limg2.place(x=204,y=0,width=1200,height=580)
